...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: MainshellWidget.routePath,
          builder: (context, params) => MainshellWidget(),
        ),
        FFRoute(
          name: HealthMonitorWidget.routeName,
          path: HealthMonitorWidget.routePath,
          builder: (context, params) => HealthMonitorWidget(),
        ),
        FFRoute(
          name: MedicationsWidget.routeName,
          path: MedicationsWidget.routePath,
          builder: (context, params) => MedicationsWidget(
        ...
        FFRoute(
          name: CaregiversWidget.routeName,
          path: CaregiversWidget.routePath,
          builder: (context, params) => CaregiversWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EmergencyNumbersWidget.routeName,
          path: EmergencyNumbersWidget.routePath,
          builder: (context, params) => EmergencyNumbersWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: MorningSetupPageWidget.routeName,
          path: MorningSetupPageWidget.routePath,
          builder: (context, params) => MorningSetupPageWidget(),
        ),
        FFRoute(
          name: LanguageRegionPageWidget.routeName,
          path: LanguageRegionPageWidget.routePath,
          builder: (context, params) => LanguageRegionPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SupportHelpPageWidget.routeName,
          path: SupportHelpPageWidget.routePath,
          builder: (context, params) => SupportHelpPageWidget(),
        ),
        FFRoute(
          name: StorageDataPageWidget.routeName,
          path: StorageDataPageWidget.routePath,
          builder: (context, params) => StorageDataPageWidget(),
        ),
        FFRoute(
