...
class EmergencyHistoryViewerCW extends StatefulWidget {
  ...
  State<EmergencyHistoryViewerCW> createState() =>
      _EmergencyHistoryViewerCWState();
}
  ...
  Widget _buildHistoryStream() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snap) {
        ...
        List<Map<String, dynamic>> events = snap.data!.docs
            .map((d) => d.data() as Map<String, dynamic>)
            .toList();

        events = _applySearch(events);
        ...
        return ListView.builder(
          ...
          itemBuilder: (c, i) => _buildEventCard(events[i]),
        );
      },
    );
  }
  ...
  Widget _buildEventCard(Map<String, dynamic> event) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: resolved ? Colors.grey.shade200 : color.withOpacity(0.18),
